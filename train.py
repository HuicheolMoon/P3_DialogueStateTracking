...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--data_dir", type=str, default="data/train_dataset"
    )
    parser.add_argument(
        "--model_dir", type=str, default="results"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--teacher_forcing_ratio", type=float, default=0.5
    )
    ...
    for epoch in range(n_epochs):
        ...
        for step, batch in enumerate(train_loader):
            ...
            all_point_outputs, all_gate_outputs = model.TRADE(
